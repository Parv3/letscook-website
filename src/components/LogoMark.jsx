 ...
 * - Scalable vector with transparent background (no raster black box).
 * - Adapts dynamically to light/dark themes:
 *   - Dark theme: White main stem, arc & mid-trace.
 *   - Light theme: Deep charcoal/black main stem, arc & mid-trace (via currentColor/var(--text-main)).
 *   - Crimson circuit traces & lower arc in brand burgundy (#a3083b).
 */
export default function LogoMark({ className = '', style = {}, size = 36, ...props }) {
  return (
    <svg 
      ...
      {...props}
    >
      {/* Theme-Adaptive Upper Arc, Stem & Center Circuit (white in dark mode, dark in light mode) */}
      <path 
        ...
        fillRule="evenodd" 
      />
      {/* Community Crimson Burgundy Lower Arc & Stepped Circuit Branches */}
      <path 
        ...
        fill="var(--accent-burgundy-hover, #a3083b)" 
        fillRule="evenodd" 
      />
    </svg>
  );
